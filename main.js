    ...
    try {
        ...
        switch (data.type) {
            ...
            case "showRegionDivision":
                ...
                //   setGrid(gridName);
                // } else {
                //   setGrid("static/guihuachengGrid.geojson");
                //   setGrid("static/hexingGrid.geojson");
                //   setGrid("static/yidaoGrid.geojson");
                //   setGrid("static/zhepuGrid.geojson");
                //   setGrid("static/puxiGrid.geojson");
                //   setGrid("static/ludaoGrid.geojson");
                //   setGrid("static/hehuaGrid.geojson");
                // }
                break;
            case "hideRegionDivision":
                ...
                // 多个社区
                // removeGrid("static/guihuachengGrid.geojson");
                // removeGrid("static/hexingGrid.geojson");
                // removeGrid("static/ludaoGrid.geojson");
                // removeGrid("static/puxiGrid.geojson");
                // removeGrid("static/yidaoGrid.geojson");
                // removeGrid("static/zhepuGrid.geojson");
                // removeGrid("static/hehuaGrid.geojson");
                break;
            default:
            ...
            if (pick.id) {
                if (pick.id.position) {
                    if (pick.id.position._value) {
                        chanedc = Cesium.SceneTransforms.worldToWindowCoordinates(viewer.scene, pick.id.position._value);
                    }
                }
            }
        }
